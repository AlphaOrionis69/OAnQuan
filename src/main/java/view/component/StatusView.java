...
public class StatusView extends StackPane {
	...
	public StatusView() {
		...
		lblP1Score = new Label("P1: 0"); lblP1Score.setFont(new Font("System Bold", 25.0)); lblP1Score.setTextFill(Color.web("#7a2e2e"));
		lblP2Score = new Label("P2: 0"); lblP2Score.setFont(new Font("System Bold", 25.0)); lblP2Score.setTextFill(Color.web("#3f5f4a"));
		lblTurn = new Label("Turn: Player 1"); lblTurn.setFont(new Font("System Bold", 25.0)); lblTurn.setTextFill(Color.web("#2f4a63"));
	...
	public void updateScore(int amount, Player player) {	
		if (player.getSide() == PlayerSide.BOTTOM) {
